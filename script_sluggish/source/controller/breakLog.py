    ...
    def segmentImportantSections(self, log_segmenting):
        ...
        for line in vet_stringAux:
            ...
            if (line.find('------ CPU INFO') != -1):
                TAG_Collect_CPU_INFO_2 = 1
            elif line.find('was the duration of \'CPU INFO\'') != -1 and (TAG_Collect_CPU_INFO_2 == 1):
                TAG_Collect_CPU_INFO_2 = 2
...
#        print(log_segmenting.strHEADER_LOG)
        ...
        log_segmenting.strCPU_INFO_2 = STR_CPU_INFO_2
